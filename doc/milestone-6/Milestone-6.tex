...
\begin{figure}
    \centering
        \includegraphics[width=\textwidth]{ms6-figures/who_vs_hm_vs_pm-incid-clean}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{ms6-figures/who_vs_hm_vs_pm-R-clean}
...
\begin{figure}
  \centering
  \includegraphics[]{ms6-figures/hm_incidence}
  \caption{Incidence data from HealthMap after the pre-processing
    steps}
  \label{fig:hm-incid}
\end{figure}
...
of incidence data were used. It is assumed that the 
