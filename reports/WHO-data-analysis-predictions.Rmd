...
national <- bind_rows(random_sample) %>%
             ...
             lapply(function(x)
                       ...
                       shuffle_cols %>% colSums) 
             

national <- lapply(national,
                   function(x)
...
here::here("output", paste0("goodness_fit_", t.proj, ".csv")) %>%
       readr::write_csv(x = goodness, path = .)
