...
guinea_training   <- guinea_byregion[1:t.proj, ]
guinea_validation <- guinea_byregion[(1 + t.proj):nrow(guinea_byregion), ]

cutoff <- which(guinea_R$Date %in%  guinea_byregion[t.proj, "Date"])
