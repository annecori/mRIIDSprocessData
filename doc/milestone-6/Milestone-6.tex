...
\begin{figure}
  ...
  \begin{figure}
    ...
    \caption{Correlation matrix between the incidence data from WHO,
      ProMED and HealthMap. Intensity of blue indicates the strength
      of the correlation.}
    \label{fig:corrplot}
  \end{figure}
...
\item scalability, we demonstrate its use for national and sub-national 
  predictions. Importantly, accessing incidence data at finer spatial scale allows
   ...
   ProMED/HealthMap data) is possible and yield promising results that could be 
...
\item generic predictions. While our effort are concentrating on predicting the spread of Ebola,
  ...
  of our approach.
\item finally, the open-source nature of our project,  both regarding the data streams 
