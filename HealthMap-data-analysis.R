params <-
structure(list(pow_dist = 2L, t.proj = 300L, n.sim = 1000L, n.dates.sim = 49L,
    p.stay = 0.99), .Names = c("pow_dist", "t.proj", "n.sim",
"n.dates.sim", "p.stay"))
